...
contract GuessContract {
    ...
    uint randomNumber = 0;
    uint tokenPerWeek = 11400;
    uint timeBtwLastWinner;
    
    /* stoch contract address */    
    BEP20Interface public randContractAddress = BEP20Interface(0x21Be8e686D745819F324f1275bed2bd4816A464D);
...
//////////////////////////////////////////////////////////////////////////////////////Modifier Definitations////////////////////////////////////////////////////////////////////////////////////////////
    ...
    modifier onlyAdmin {
        require (msg.sender ==  0x5B38Da6a701c568545dCfcB03FcB875f56beddC4  , 'Only Admin has right to execute this function');
        _;
...
//////////////////////////////////////////////////////////////////////////////////////Staking Function//////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    //   require ( StakerInfos[msg.sender].isStaking == false, "You have already staked once in this pool.You cannot staked again.Wait for next batch") ;
       require (BEP20Interface(randContractAddress).transferFrom(msg.sender, address(this), _amount.mul(10**18)));
       ...
       StakerInfos[msg.sender].maxNumberUserCanChoose = (StakerInfos[msg.sender].stakingBalance).div(100); 
    ...
    */
    function chooseNumbers(uint[] memory _number) public onlyStaked() returns(uint[] memory){
        ...
        require(_number[i] >= 1 && _number[i] <= 10000);
    ...
    */
    ...
    function unstakeTokens() public onlyStaked() {
        ...
        require(BEP20Interface(randContractAddress).transferGuess(msg.sender, balance.mul(10**18)));
    ...
    function chooseWinner() public onlyAdmin returns(address) {
        ...
        require(BEP20Interface(randContractAddress).transferGuess(user, winnerRewards));
    ...
    function generateRandomNumber(uint _seed_value ) public onlyAdmin returns (uint) {
        uint ranNum = uint256(keccak256(abi.encodePacked(block.difficulty,block.timestamp,_seed_value)))%1000+1;
        randomNumber = ranNum;
        return randomNumber;
    }
